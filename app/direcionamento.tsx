...
export default function OnboardingDirecionamento() {
    ...
    <SafeAreaView className="flex-1 bg-gradient-to-b from-sky-900 via-sky-600 to-teal-400 justify-between p-6">
      ...
      <View className="items-center">
        <View className="bg-sky-100/90 w-full h-64 rounded-2xl items-center justify-center p-4 mb-8">
          <Text className="text-sky-900 text-center font-medium">[ Diagrama UBS - UPA - Hospital ]</Text>
        </View>

        <View className="w-full">
          <Text className="text-white text-2xl font-serif mb-2">Saiba para onde ir</Text>
          <Text className="text-sky-100 text-sm leading-5">
            Não sabe se deve ir à UBS, UPA ou Hospital? Nosso assistente ajuda a identificar o local correto para o seu caso, com base em seus sintomas.
          </Text>
        </View>
      </View>
